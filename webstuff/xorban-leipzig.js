...
(function (global, factory) {
  ...
  */
  var abbreviations = {
    ...
    ABS: 'absolutive',
    ACC: 'accusative',
    ACLAUSE: 'matrix clause',
    ADJ: 'adjective',
    ADV: 'adverb(ial)',
    AFF: 'affirmative polarity marker',
    AGR: 'agreement',
    ALL: 'allative',
    ANTIP: 'antipassive',
    APPL: 'applicative',
    ...
    CAUS: 'causative',
    CLF: 'classifier',
    CNJ: 'logical conjunction marker',
    COM: 'comitative',
    COMP: 'complementizer',
    COMPL: 'completive',
    COND: 'conditional',
    ...
    DEM: 'demonstrative',
    DET: 'determiner',
    DETC: 'determiner consonant',
    DISJ: 'logical disjunction marker',
    DIST: 'distal',
    DISTR: 'distributive',
    DU: 'dual',
    DUR: 'durative',
    ...
    LOC: 'locative',
    M: 'masculine',
    MCLAUSE: 'matrix clause',
    N: 'neuter',
    NEG: 'negative polarity marker',
    ...
    SEP: 'separator',
    SG: 'singular',
    TAUT: 'tautological polarity marker',
    TOP: 'topic',
    TR: 'transitive',
    VAR: 'variable',
    VOC: 'vocative'
